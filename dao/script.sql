...
-- Mostra a estrutura da tabela
 ...
 alter table aluno 
 MODIFY aluno.email varchar(150) not null;

-- insere dados na tabela aluno
 INSERT into aluno(aluno.nome, aluno.email, aluno.tel, aluno.ativo) 
 VALUES ("Ana Maria", "ana@email.com", "5555-6677", true);

 INSERT INTO aluno 
 Value 
 (null, "Pedro Cunha", "pedro@email.com", "555-7788", true), 
 (null, "Bia Silva", "bia@email.com", "555-4456", true);

 INSERT into aluno(aluno.nome, aluno.email, aluno.tel, aluno.ativo, aluno.datanasc, aluno.pws) 
 VALUES 
